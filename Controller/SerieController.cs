...
namespace Cadastro_Series
{
    public class SerieController : ControllerAbstract
    {
        ...
        public override void InserirSerie()
        {
        ...
        public override void ListarSerie()
        {
            Console.WriteLine("SERIES CADASTRADAS:");
            serieRepositorio.Listar();
        }
        public override void VisualizarSerie()
        {
        ...
        public override void AtualizarSerie()
        {
        ...
        public override void ExcluirSerie()
        {
            Console.WriteLine("Metodos de busca: ");
            Console.WriteLine($"{Environment.NewLine}");
            Serie serie = null;
